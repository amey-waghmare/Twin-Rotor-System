...
mpu.configure()
mag_bias = [15.1166, 13.7999, -47.9528]
mag_A_inv = [[0.84, 0.0034, 0.01],[0.0034, 0.827806, -0.053738],[0.010058, -0.053738, 0.907451]]
...
magneto = np.array(magneto)
np.savetxt("magnetometer_readings.csv", magneto, delimiter = "\t")
