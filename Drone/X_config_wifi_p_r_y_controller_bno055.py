...
while True:
    ...
    if data[:3] == "pit":
        ...
        drone_hover_pwm = drone_hover_pwm + 10
    elif data == "ds":
        drone_hover_pwm = drone_hover_pwm - 10
    elif data == "alloff":
        break
    ...
    if meas_yaw != None or meas_roll != None or meas_pitch != None:
        ...
        pitch_error = int(pitch_error)
        escF.set(drone_hover_pwm + pitch_error)
        escB.set(drone_hover_pwm - pitch_error)
        escR.set(drone_hover_pwm - pitch_error)
        escL.set(drone_hover_pwm + pitch_error)
        ...
        escF.set(drone_hover_pwm - roll_error)
        escB.set(drone_hover_pwm + roll_error)
        escR.set(drone_hover_pwm - roll_error)
        escL.set(drone_hover_pwm + roll_error)
        ...
        escF.set(drone_hover_pwm + yaw_error)
        escB.set(drone_hover_pwm + yaw_error)
        escR.set(drone_hover_pwm - yaw_error)
        escL.set(drone_hover_pwm - yaw_error)
        ...
        ## Debug
        print("PITCH: {:.2f}\t ROLL: {:.2f}\t YAW: {:.2f}\t PWM_F: {}\t PWM_R: {}\t PWM_Y: {}\t Hover_PWM: {}".format( meas_pitch, meas_roll, meas_yaw, pitch_error, roll_error, yaw_error, drone_hover_pwm)) 
